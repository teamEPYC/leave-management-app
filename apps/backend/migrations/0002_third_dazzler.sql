CREATE TYPE "public"."invitation_status" AS ENUM('SENT', 'ACCEPT');--> statement-breakpoint
...
CREATE TABLE "organizations" (
	...
	"setting" json DEFAULT '{}'::json NOT NULL,
...
CREATE UNIQUE INDEX "user_email_key" ON "users" USING btree ("email") WHERE "users"."is_active";